...
//import addRecordSharing script
var addRecordSharing = document.createElement('script');
addRecordSharing.src = base_url + 'resource/js/custom/addRecordSharing.js';
addRecordSharing.setAttribute("type", "text/javascript");
document.head.appendChild(addRecordSharing);
