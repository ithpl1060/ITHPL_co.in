...
<form id="changePasswordForm">
    ...
    <div class="input-group">
        <input type="password" id="uPassword" name="uPassword" class="form-control rounded-left text-center"
    ...
    <div class="input-group">
        <input type="password" id="uConfirmPassword" name="uConfirmPassword" class="form-control rounded-left text-center"
            placeholder="Confirm New Password" style="font-size:14px">
        <div class="input-group-append">
