  ...
  <div id="appleSubmenu"
    ...
    <main>
        ...
        <section class="hero-section-s">
            <div class="hero-bg">
                <img src="<?= base_url(relativePath: 'images/abstract-green-bg.png'); ?>"
                ...
                <div class="image-carousel-container ">
                    <div class="image-carousel">
                        <div class="carousel-inner ">
                            ...
                            <img src="<?= base_url(relativePath: 'images/recycle-paper.png'); ?>"
                                alt="Digital workplace" class="carousel-slide active">
                            <img src="<?= base_url(relativePath: 'images/renewable-energy.png'); ?>"
                                alt="Clean energy solutions" class="carousel-slide">
                        </div>
                    </div>
                </div>
            </div>
  ...
  <div class="why-sustainability-content">
    <div class="why-sustainability-image"   id="sec-why-sus">
            ...
            <div class="initiatives-grid">
                ...
                <div class="initiative-card">
                    <div class="initiative-image-wrapper">
                        <div class="initiative-icon">
                            <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt="green-circle"
                                class="icon-bg">
                            <img src="<?= base_url(relativePath: 'images/zero-printout-icon.png'); ?>"
                                alt="Zero Printouts Icon" class="icon-fg">
                        </div>
                        <div class="card-inner">
                            <div class="card-front">
                                <img src="<?= base_url(relativePath: 'images/office_with_no_print.png'); ?>"
                                    alt="Office with no printouts">
                            </div>
                ...
                <div class="initiative-card">
                    <div class="initiative-image-wrapper">
                        <div class="initiative-icon">
                            ...
                            <img src="<?= base_url(relativePath: 'images/hand-icon.png'); ?>" alt="Hand Icon"
                                class="icon-fg">
                        </div>
                        <div class="card-inner">
                            <div class="card-front">
                                <img src="<?= base_url(relativePath: 'images/hand_dryer.png'); ?>"
                                    alt="Hand dryer in a washroom">
                            </div>
                ...
                <div class="initiative-card">
                    <div class="initiative-image-wrapper">
                        <div class="initiative-icon">
                            <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt="" class="icon-bg">
                            <img src="<?= base_url(relativePath: 'images/led_bulb_icon.png'); ?>" alt="LED Bulb Icon"
                                class="icon-fg">
                        </div>
                        <div class="card-inner">
                            <div class="card-front">
                ...
                <div class="initiative-card">
                    <div class="initiative-image-wrapper">
                        <div class="initiative-icon">
                            <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt="" class="icon-bg">
                            <img src="<?= base_url(relativePath: 'images/solar_icon_energy.png'); ?>"
                                alt="Solar Energy Icon" class="icon-fg">
                        </div>
                        <div class="card-inner">
                            <div class="card-front">
                                <img src="<?= base_url(relativePath: 'images/solar_panels.png'); ?>"
                ...
                <div class="initiative-card">
                    <div class="initiative-image-wrapper">
                        <div class="initiative-icon">
                            <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt="" class="icon-bg">
                            <img src="<?= base_url(relativePath: 'images/packaging_icon.png'); ?>" alt="Packaging Icon"
                                class="icon-fg">
                        </div>
                        <div class="card-inner">
                            <div class="card-front">
                                <img src="<?= base_url(relativePath: 'images/eco_friendly_card.png'); ?>"
                                    alt="Eco-friendly cardboard boxes">
                            </div>
                ...
                <div class="initiative-card">
                    <div class="initiative-image-wrapper">
                        <div class="initiative-icon">
                            <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt="" class="icon-bg">
                            <img src="<?= base_url(relativePath: 'images/waste-segragation-icon.png'); ?>"
                                alt="Waste Segregation Icon" class="icon-fg">
                        </div>
                        <div class="card-inner">
                            <div class="card-front">
                                <img src="<?= base_url(relativePath: 'images/segragated-waste-bins.png'); ?>"
                ...
                <div class="initiative-card">
                    <div class="initiative-image-wrapper">
                        <div class="initiative-icon">
                            <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt="" class="icon-bg">
                            <img src="<?= base_url(relativePath: 'images/recycle_icon.png'); ?>" alt="Recycle Icon"
                                class="icon-fg">
                        </div>
                        <div class="card-inner">
                            <div class="card-front">
                                <img src="<?= base_url(relativePath: 'images/waste-bins.png'); ?>"
                ...
                <div class="initiative-card">
                    <div class="initiative-image-wrapper">
                        <div class="initiative-icon">
                            <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt="" class="icon-bg">
                            <img src="<?= base_url(relativePath: 'images/glass-icon.png'); ?>" alt="Glass Icon"
                                class="icon-fg">
                        </div>
                        <div class="card-inner">
                            <div class="card-front">
                                <img src="<?= base_url(relativePath: 'images/glass-bottles.png'); ?>"
            ...
            <div class="certified-content">
                <div class="certified-image">
                    ...
                    <div class="certified-badge">
                        ...
                        <img src="<?= base_url(relativePath: 'images/iso-14001-certified.png'); ?>"
                            alt="ISO 14001 Certified Badge" class="badge-fg">
                    </div>
                </div>
                <div class="certified-text">
                    <div class="certified-header">
                        <img src="<?= base_url(relativePath: 'images/eco-label-icon.png'); ?>" alt="Eco Label Icon"
                            class="eco-label-icon">
        ...
        <section id="section-impact" class="py-16 px-4 bg-gray-50">
            <h2 class="text-center text-4xl md:text-5xl font-bold mb-8">Our <span
                ...
                <div
                    ...
                    <div class="liquid-container absolute bottom-0 w-full h-[82.67%] overflow-hidden">
                        <svg viewBox="0 0 200 200" preserveAspectRatio="none" class="w-full h-full animate-wave"
                            ...
                            <path fill="url(#liquid-green-2)" d="M0,120 Q50,100 100,120 T200,120 L200,200 L0,200 Z" />
                        </svg>
                    </div>
                ...
                <div
                    ...
                    <div class="liquid-container absolute bottom-0 w-full h-[80%] overflow-hidden">
                        <svg viewBox="0 0 200 200" preserveAspectRatio="none" class="w-full h-full animate-wave"
                            ...
                            <path fill="url(#liquid-green-3)" d="M0,120 Q50,100 100,120 T200,120 L200,200 L0,200 Z" />
                        </svg>
                    </div>
                ...
                <div
                    ...
                    <div class="liquid-container absolute bottom-0 w-full h-[86%] overflow-hidden">
                        <svg viewBox="0 0 200 200" preserveAspectRatio="none" class="w-full h-full animate-wave"
                            ...
                            <path fill="url(#liquid-green-4)" d="M0,120 Q50,100 100,120 T200,120 L200,200 L0,200 Z" />
                        </svg>
                    </div>
        ...
        <section id="section-cta" class="cta-section">
            <div class="cta-bg">
                <img src="<?= base_url(relativePath: 'images/green-solar-bg.png'); ?>"
                    alt="Green solar panels background">
            </div>
