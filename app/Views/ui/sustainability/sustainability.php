                    ...
                    <div class="image-carousel-container ">
                        <div class="image-carousel ">
                            <div class="carousel-inner ">
                                <img src="<?= base_url(relativePath: 'images/tree-planting.png'); ?>"
                                    alt="Tree planting" class="carousel-slide ">
            ...
            <section id="section-initiatives" class="page-container">
                ...
                <div class="initiatives-grid">
                    ...
                    <div class="initiative-card">
                        <div class="initiative-image-wrapper">
                            <div class="initiative-icon">
                                <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt=""
                                    class="icon-bg">
                    ...
                    <div class="initiative-card">
                        <div class="initiative-image-wrapper">
                            <div class="initiative-icon">
                                <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt=""
                                    class="icon-bg">
                                <img src="<?= base_url(relativePath: 'images/led_bulb_icon.png'); ?>"
                                    alt="LED Bulb Icon" class="icon-fg">
                            </div>
                            <div class="card-inner">
                                <div class="card-front">
                                    <img src="<?= base_url(relativePath: 'images/led_bulbs.png'); ?>"
                                        alt="LED light bulbs">
                                </div>
                    ...
                    <div class="initiative-card">
                        <div class="initiative-image-wrapper">
                            <div class="initiative-icon">
                                <img src="<?= base_url(relativePath: 'images/green-circle.png'); ?>" alt=""
                                    class="icon-bg">
                                <img src="<?= base_url(relativePath: 'images/packaging_icon.png'); ?>"
                                    alt="Packaging Icon" class="icon-fg">
                            </div>
                            <div class="card-inner">
                                <div class="card-front">
                ...
                <div class="certified-content">
                    <div class="certified-image">
                        ...
                        <div class="certified-badge">
                            <img src="<?= base_url(relativePath: 'images/eclipse-white.png'); ?>" alt=""
                                class="badge-bg">
