...
<body>
  ...
  <div class="channel-html GjvmrWqq">
    ...
    <div class="section cauzdowm theme-dark" id="sec-hero">
          ...
          <span class="column MbgULiuT large-12"><div class="row TJAFHioy large-display-bleed medium-display-bleed small-display-bleed">
              <span class="column lOTVntta"><h2>
                  <figure class="responsive-image channel-picture has-large has-medium has-small">
                    <img class="image uZknhopH image-large is-largest" alt="Apple Watch ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>logo_hero_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>logo_hero_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>logo_hero_large.png"><img class="image uZknhopH image-medium" alt="Apple Watch ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>logo_hero_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>logo_hero_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>logo_hero_medium.png"><img class="image uZknhopH image-small" alt="Apple Watch ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>logo_hero_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>logo_hero_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>logo_hero_small.png">
                  </figure></h2></span>
            </div>
            ...
            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                <img class="image QixTTypz image-large is-largest" alt="Apple Watch Ultra 4, titanium case, natural color, digital clock face, complications: readiness, heart rate, Workouts, temperature, right side exterior, Digital Crown, raised side button, Ocean Band, translucent gray color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>hero_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>hero_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>hero_large.png"><img class="image QixTTypz image-medium" alt="Apple Watch Ultra 4, titanium case, natural color, digital clock face, complications: readiness, heart rate, Workouts, temperature, right side exterior, Digital Crown, raised side button, Ocean Band, translucent gray color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>hero_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>hero_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>hero_medium.png"><img class="image QixTTypz image-small" alt="Apple Watch Ultra 4, titanium case, natural color, digital clock face, complications: readiness, heart rate, Workouts, temperature, right side exterior, Digital Crown, raised side button, Ocean Band, translucent gray color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>hero_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>hero_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>hero_small.png"></figure></span>
                    ...
                    <div class="bento-box MckLTHyz">
                      <span class="bentobox-item rUFiJVua"><div class="row VfMkaSyo medium-display-bleed small-display-bleed">
                          <div class="column IAEAcWxH large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image iwZKeXun double-invert image-large is-largest" alt="A person running while wearing Apple Watch Ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>battery_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>battery_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>battery_large.png"><img class="image iwZKeXun double-invert image-medium" alt="A person running while wearing Apple Watch Ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>battery_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>battery_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>battery_medium.png"><img class="image iwZKeXun double-invert image-small" alt="A person running while wearing Apple Watch Ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>battery_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>battery_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>battery_small.png"></figure></span>
                          </div>
                    ...
                    <div class="bento-box nkCfYyxJ">
                      <span class="bentobox-item KbbnWstN"><div class="row UWOkfDyX medium-display-bleed small-display-bleed">
                          <div class="column QpZJXYps large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image FmmSHtub double-invert image-large is-largest" alt="Back of Apple Watch Ultra 4, titanium case, black color, multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_health_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_health_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_health_large.png"><img class="image FmmSHtub double-invert image-medium" alt="Back of Apple Watch Ultra 4, titanium case, black color, multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_health_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_health_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_health_medium.png"><img class="image FmmSHtub double-invert image-small" alt="Back of Apple Watch Ultra 4, titanium case, black color, multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_health_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_health_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_health_small.png"></figure></span>
                          </div>
                  ...
                  <div class="column YVqaxPpK large-12">
                    <div class="bento-box nkCfYyxJ">
                      <span class="bentobox-item KbbnWstN"><div class="row UWOkfDyX medium-display-bleed small-display-bleed">
                          <div class="column QpZJXYps large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image FmmSHtub double-invert image-large is-largest" alt="Person wearing Apple Watch Ultra 4 on wrist, Daytime Vitals slightly off" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_rate_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_rate_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_rate_large.png"><img class="image FmmSHtub double-invert image-medium" alt="Person wearing Apple Watch Ultra 4 on wrist, Daytime Vitals slightly off" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_rate_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_rate_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_rate_medium.png"><img class="image FmmSHtub double-invert image-small" alt="Person wearing Apple Watch Ultra 4 on wrist, Daytime Vitals slightly off" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_rate_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_rate_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>heart_rate_small.png"></figure></span>
                          </div>
                          <div class="column VgGlUfnb large-12">
                    ...
                    <div class="bento-box pTUropmP">
                      <span class="bentobox-item DFVaxapa"><div class="row KSsrfKtK medium-display-bleed small-display-bleed">
                          <div class="column czkSgsyN large-12">
                            ...
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image OyCnYktm double-invert image-large is-largest" alt="Apple Watch Ultra 4, titanium case, natural color, readiness score of 8, right side exterior, Digital Crown, raised side button, Ocean Band, translucent gray color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>readiness_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>readiness_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>readiness_large.png"><img class="image OyCnYktm double-invert image-medium" alt="Apple Watch Ultra 4, titanium case, natural color, readiness score of 8, right side exterior, Digital Crown, raised side button, Ocean Band, translucent gray color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>readiness_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>readiness_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>readiness_medium.png"><img class="image OyCnYktm double-invert image-small" alt="Apple Watch Ultra 4, titanium case, natural color, readiness score of 8, right side exterior, Digital Crown, raised side button, Ocean Band, translucent gray color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>readiness_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>readiness_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>readiness_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box lurrhenW">
                      <span class="bentobox-item gLUMPPtm"><div class="row kOFdilwM medium-display-bleed small-display-bleed">
                          <div class="column ysHBWPwM large-12">
                            ...
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image eRowewwA image-large is-largest" alt="Apple Watch Ultra 4, titanium case, natural color, advanced Outdoor Run workout metrics, right side exterior, Digital Crown, raised side button, Trail Loop band, sand color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>running_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>running_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>running_large.png"><img class="image eRowewwA image-medium" alt="Apple Watch Ultra 4, titanium case, natural color, advanced Outdoor Run workout metrics, right side exterior, Digital Crown, raised side button, Trail Loop band, sand color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>running_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>running_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>running_medium.png"><img class="image eRowewwA image-small" alt="Apple Watch Ultra 4, titanium case, natural color, advanced Outdoor Run workout metrics, right side exterior, Digital Crown, raised side button, Trail Loop band, sand color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>running_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>running_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>running_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box nRShwBwM">
                      <span class="bentobox-item UujoTUuO"><div class="row qXyLjzxe medium-display-bleed small-display-bleed">
                          <div class="column jZKUDVsm large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image KwBeZDBT image-large is-largest" alt="Apple Watch Ultra 4, titanium case, black color, Running workout, next interval, left side exterior, orange Action button, Alpine Loop band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>action_button_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>action_button_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>action_button_large.png"><img class="image KwBeZDBT image-medium" alt="Apple Watch Ultra 4, titanium case, black color, Running workout, next interval, left side exterior, orange Action button, Alpine Loop band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>action_button_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>action_button_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>action_button_medium.png"><img class="image KwBeZDBT image-small" alt="Apple Watch Ultra 4, titanium case, black color, Running workout, next interval, left side exterior, orange Action button, Alpine Loop band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>action_button_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>action_button_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>action_button_small.png"></figure></span>
                          </div>
                    ...
                    <div class="bento-box aDkqDKsM">
                      <span class="bentobox-item QlepACpI"><div class="row JcUdshwF small-display-bleed">
                          <div class="column jwtsSFwl large-12">
                            ...
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image oveDnNzt image-large is-largest" alt="Three Apple Watch Ultra 4 devices, one with black titanium case, Siri AI conversation, translucent black Ocean Band, one with natural titanium case, personalized photo on watch face with Siri AI complication, natural titanium Milanese Loop band, and one with black titanium case, Siri Recap, burgundy Trail Loop band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>wearable_AI_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>wearable_AI_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>wearable_AI_large.png"><img class="image oveDnNzt image-medium" alt="Three Apple Watch Ultra 4 devices, one with black titanium case, Siri AI conversation, translucent black Ocean Band, one with natural titanium case, personalized photo on watch face with Siri AI complication, natural titanium Milanese Loop band, and one with black titanium case, Siri Recap, burgundy Trail Loop band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>wearable_AI_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>wearable_AI_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>wearable_AI_medium.png"><img class="image oveDnNzt image-small" alt="Three Apple Watch Ultra 4 devices, one with black titanium case, Siri AI conversation, translucent black Ocean Band, one with natural titanium case, personalized photo on watch face with Siri AI complication, natural titanium Milanese Loop band, and one with black titanium case, Siri Recap, burgundy Trail Loop band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>wearable_AI_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>wearable_AI_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>wearable_AI_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box aGOCrBoc">
                      <span class="bentobox-item QyoMQxBy"><div class="row eBCnOOnG medium-display-bleed small-display-bleed">
                          <div class="column ISfNLurI large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image bHtRJnsc image-large is-largest" alt="Apple Watch Ultra 4, titanium case, natural color, Backtrack showing route with compass directions, right side exterior, Digital Crown, raised side button" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>adventure_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>adventure_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>adventure_large.png"><img class="image bHtRJnsc image-medium" alt="Apple Watch Ultra 4, titanium case, natural color, Backtrack showing route with compass directions, right side exterior, Digital Crown, raised side button" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>adventure_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>adventure_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>adventure_medium.png"><img class="image bHtRJnsc image-small" alt="Apple Watch Ultra 4, titanium case, natural color, Backtrack showing route with compass directions, right side exterior, Digital Crown, raised side button" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>adventure_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>adventure_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>adventure_small.png"></figure></span>
                          </div>
                    ...
                    <div class="bento-box Lrmbeoyl">
                      <span class="bentobox-item IEODSbyv"><div class="row qIHsHDpE small-display-bleed">
                          <div class="column VSKLaYnL large-12">
                            ...
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image GSaBqnny image-large is-largest" alt="Apple Watch Ultra 4, titanium case, black color, satellite connection, right side exterior, Digital Crown, raised side button, Alpine Loop band, burgundy color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>safety_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>safety_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>safety_large.png"><img class="image GSaBqnny image-medium" alt="Apple Watch Ultra 4, titanium case, black color, satellite connection, right side exterior, Digital Crown, raised side button, Alpine Loop band, burgundy color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>safety_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>safety_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>safety_medium.png"><img class="image GSaBqnny image-small" alt="Apple Watch Ultra 4, titanium case, black color, satellite connection, right side exterior, Digital Crown, raised side button, Alpine Loop band, burgundy color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>safety_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>safety_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>safety_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                                ...
                                <div class="bentobox-item BpJVCcoz">
                                  <div class="row PejhMNoW medium-display-bleed small-display-bleed">
                                    <div class="column MIVulCnM large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image RRiCmIvm double-invert image-large is-largest" alt="Back of Apple Watch Ultra 4, titanium case, black color, multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_sensor_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_sensor_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_sensor_large.png"><img class="image RRiCmIvm double-invert image-medium" alt="Back of Apple Watch Ultra 4, titanium case, black color, multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_sensor_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_sensor_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_sensor_medium.png"><img class="image RRiCmIvm double-invert image-small" alt="Back of Apple Watch Ultra 4, titanium case, black color, multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_sensor_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_sensor_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_sensor_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item VwQbBtBm">
                                  <div class="row GWRrRItv large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column KcjSYDuQ large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image sFNecxtw double-invert image-large is-largest" alt="Apple Watch Ultra 4, titanium case, black color, readiness score of 8, right side exterior, Digital Crown, raised side button" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_HRV_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_HRV_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_HRV_large.png"><img class="image sFNecxtw double-invert image-medium" alt="Apple Watch Ultra 4, titanium case, black color, readiness score of 8, right side exterior, Digital Crown, raised side button" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_HRV_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_HRV_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_HRV_medium.png"><img class="image sFNecxtw double-invert image-small" alt="Apple Watch Ultra 4, titanium case, black color, readiness score of 8, right side exterior, Digital Crown, raised side button" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_HRV_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_HRV_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_HRV_small.png"></figure></span>
                                ...
                                <div class="bentobox-item PBEptert">
                                  <div class="row ELNWBJtw large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column QsMdQlsI large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image eyUHrcqM double-invert image-large is-largest" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_Siri_AI_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_Siri_AI_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_Siri_AI_large.png"><img class="image eyUHrcqM double-invert image-medium" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_Siri_AI_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_Siri_AI_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_Siri_AI_medium.png"><img class="image eyUHrcqM double-invert image-small" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_Siri_AI_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_Siri_AI_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_Siri_AI_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item WgVjQymB">
                                  <div class="row lzNUPpxV large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column CtVEKnyU large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image ieOxUjwh double-invert image-large is-largest" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_health_app_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_health_app_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_health_app_large.png"><img class="image ieOxUjwh double-invert image-medium" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_health_app_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_health_app_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_health_app_medium.png"><img class="image ieOxUjwh double-invert image-small" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_health_app_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_health_app_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_health_app_small.png"></figure></span>
                                ...
                                <div class="bentobox-item uWZqLqzY">
                                  <div class="row eJKfsHwv large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column nQwLnFuy large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image eziTpJBW image-large is-largest" alt="Globe showing user location with satellite icon above" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_faster_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_faster_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_faster_large.png"><img class="image eziTpJBW image-medium" alt="Globe showing user location with satellite icon above" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_faster_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_faster_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_faster_medium.png"><img class="image eziTpJBW image-small" alt="Globe showing user location with satellite icon above" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_faster_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_faster_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Ultra_faster_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item kwtQMnBo">
                                  <div class="row FPRHNluH large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column oAXxqwnw large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image PnYXrnnX double-invert image-large is-largest" alt="Apple Watch Ultra 4, titanium case, black color, Race Route feature with a map of a running route, left side exterior, Action button, Alpine Loop band, burgundy color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_action_button_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_action_button_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_action_button_large.png"><img class="image PnYXrnnX double-invert image-medium" alt="Apple Watch Ultra 4, titanium case, black color, Race Route feature with a map of a running route, left side exterior, Action button, Alpine Loop band, burgundy color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_action_button_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_action_button_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_action_button_medium.png"><img class="image PnYXrnnX double-invert image-small" alt="Apple Watch Ultra 4, titanium case, black color, Race Route feature with a map of a running route, left side exterior, Action button, Alpine Loop band, burgundy color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_action_button_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_action_button_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_action_button_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item qFeKscxW">
                                  <div class="row ahSwPvqk medium-display-bleed small-display-bleed">
                                    <div class="column JiDEXqqy large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image unWQXVpw double-invert image-large is-largest" alt="Back of Apple Watch Ultra 4, titanium case, black color, multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_sensor_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_sensor_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_sensor_large.png"><img class="image unWQXVpw double-invert image-medium" alt="Back of Apple Watch Ultra 4, titanium case, black color, multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_sensor_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_sensor_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_sensor_medium.png"><img class="image unWQXVpw double-invert image-small" alt="Back of Apple Watch Ultra 4, titanium case, black color, multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_sensor_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_sensor_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_sensor_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item miQxElnm">
                                  <div class="row PJNDeTww medium-display-bleed small-display-bleed">
                                    <div class="column AhrJCqtR large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image KaWYRwBk double-invert image-large is-largest" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_Siri_AI_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_Siri_AI_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_Siri_AI_large.png"><img class="image KaWYRwBk double-invert image-medium" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_Siri_AI_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_Siri_AI_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_Siri_AI_medium.png"><img class="image KaWYRwBk double-invert image-small" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_Siri_AI_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_Siri_AI_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_Siri_AI_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item oYOaTDnK">
                                  <div class="row BzisEdug large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column VXIHXmmA large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image vLGNuxAA double-invert image-large is-largest" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_HRV_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_HRV_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_HRV_large.png"><img class="image vLGNuxAA double-invert image-medium" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_HRV_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_HRV_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_HRV_medium.png"><img class="image vLGNuxAA double-invert image-small" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_HRV_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_HRV_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_HRV_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item jGmpvAsH">
                                  <div class="row JYmJkPxO large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column vyhubsyV large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image wdrFQqnR double-invert image-large is-largest" alt="Apple Watch Ultra 4, titanium case, black color, Depth app showing diving metrics, right side exterior, Digital Crown, raised side button" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_durability_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_durability_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_durability_large.png"><img class="image wdrFQqnR double-invert image-medium" alt="Apple Watch Ultra 4, titanium case, black color, Depth app showing diving metrics, right side exterior, Digital Crown, raised side button" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_durability_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_durability_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_durability_medium.png"><img class="image wdrFQqnR double-invert image-small" alt="Apple Watch Ultra 4, titanium case, black color, Depth app showing diving metrics, right side exterior, Digital Crown, raised side button" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_durability_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_durability_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>upgrader_Series_durability_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div role="row" class="compare-row compare-template-space-bottom compare-template-preview-item-embeded-image" data-column-group="true">
                        ...
                        <div role="cell" class="compare-column" headers="compare-header-0">
                          <div aria-hidden="false" class="PKJcYpmX embed-image">
                            <figure class="responsive-image compare-image has-large has-small">
                              <img class="image double-invert image-large is-largest" alt="Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_series_12_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_series_12_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_series_12_large.png"><img class="image double-invert image-small" alt="Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_series_12_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_series_12_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_series_12_small.png">
                            </figure>
                          </div>
                        </div>
                        <div role="cell" class="compare-column" headers="compare-header-1">
                          <div aria-hidden="false" class="fkRmJTBv embed-image">
                            <figure class="responsive-image compare-image has-large has-small">
                              <img class="image double-invert image-large is-largest" alt="Apple Watch Ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_ultra_4_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_ultra_4_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_ultra_4_large.png"><img class="image double-invert image-small" alt="Apple Watch Ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_ultra_4_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_ultra_4_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_ultra_4_small.png">
                            </figure>
                          </div>
                        </div>
                        <div role="cell" class="compare-column" headers="compare-header-2">
                          <div aria-hidden="false" class="vCC5FA1 embed-image">
                            <figure class="responsive-image compare-image has-large has-small">
                              <img class="image double-invert image-large is-largest" alt="Apple Watch SE 3" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_SE_3_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_SE_3_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_SE_3_large.png"><img class="image double-invert image-small" alt="Apple Watch SE 3" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_SE_3_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_SE_3_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>compare_apple_watch_SE_3_small.png">
                            </figure>
                          </div>
                        </div>
                      </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="ANSbEAAr embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_applewatch_case_sizes_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_applewatch_case_sizes_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_applewatch_case_sizes_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="YrVpgTsG embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_applewatch_case_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_applewatch_case_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_applewatch_case_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="WzljhNBy embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_watchface_applewatch_case_inset_filled_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_watchface_applewatch_case_inset_filled_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_watchface_applewatch_case_inset_filled_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="YmRPMapH embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_watchhealth_heart_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_watchhealth_heart_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_watchhealth_heart_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="xeYTDJAu embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_bed_double_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_bed_double_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_bed_double_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="qyFLWhyO embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_apple_vitals_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_apple_vitals_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_apple_vitals_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="HgyeLOrE embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_cycletracking_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_cycletracking_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_cycletracking_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 49px">
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="nhsEDlzi embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_apple_intelligence_gradient_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_apple_intelligence_gradient_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_apple_intelligence_gradient_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 33px">
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="bWinYYoc embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_sos_circle_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_sos_circle_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_sos_circle_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 33px">
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="agOmXSpl embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_drop_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_drop_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_drop_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 33px">
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="uiaTsRwz embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_antenna_radiowaves_left_and_right_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_antenna_radiowaves_left_and_right_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_antenna_radiowaves_left_and_right_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="qTdDStzy embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_chip_s11_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_chip_s11_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_chip_s11_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="c956FED embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_chip_s10_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_chip_s10_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_chip_s10_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="yRHpNoBt embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_battery_100percent_bolt_elevated_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_battery_100percent_bolt_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>icon_compare_battery_100percent_bolt_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 33px">
            ...
            <div class="bento-box HFlLuvxe">
              <span class="bentobox-item XzPSTbrI"><div class="row OxiLObrv">
                  ...
                  <div class="column jrZoJltg large-hide medium-hide small-show large-12">
                    <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image QVudohpT image-large is-largest" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_large.png"><img class="image QVudohpT image-medium" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_medium.png"><img class="image QVudohpT image-small" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_small.png"></figure></span>
                  </div>
                  <div class="column NmjHYbvB large-show medium-show small-hide large-6 medium-6 small-12">
                    <div>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image wsIbcdAi image-large is-largest" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, starlight Sport Band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_large.png"><img class="image wsIbcdAi image-medium" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, starlight Sport Band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_medium.png"><img class="image wsIbcdAi image-small" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, starlight Sport Band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_bands_small.png">
                      </figure>
                    </div>
                  </div></div></span>
            </div>
            ...
            <div class="bento-box qsILGJpm">
              <span class="bentobox-item DOjrxrnH"><div class="row BwJpydnY large-display-bleed medium-display-bleed small-display-bleed">
                  ...
                  <div class="column ImRtaVAx large-6 medium-6 small-12">
                    <div>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image IAlhaJxn image-large is-largest" alt="Apple Watch Series 12, Aluminium case, black color, black Sport Band, Apple Music app open, paired with AirPods 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_and_airpods_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_and_airpods_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_and_airpods_large.png"><img class="image IAlhaJxn image-medium" alt="Apple Watch Series 12, Aluminium case, black color, black Sport Band, Apple Music app open, paired with AirPods 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_and_airpods_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_and_airpods_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_and_airpods_medium.png"><img class="image IAlhaJxn image-small" alt="Apple Watch Series 12, Aluminium case, black color, black Sport Band, Apple Music app open, paired with AirPods 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_and_airpods_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_and_airpods_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_and_airpods_small.png">
                      </figure>
                    </div>
                  </div></div></span>
            </div>
            ...
            <div class="bento-box dpZhyqyg">
              <span class="bentobox-item AyrGrJuZ"><div class="row AwBErZtJ large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column hWOacYpY large-7 medium-6 small-12">
                    <h2>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image fqLahtxr image-large is-largest" alt="Apple Fitness+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_fitness_plus_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_fitness_plus_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_fitness_plus_large.png"><img class="image fqLahtxr image-medium" alt="Apple Fitness+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_fitness_plus_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_fitness_plus_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_fitness_plus_medium.png"><img class="image fqLahtxr image-small" alt="Apple Fitness+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_fitness_plus_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_fitness_plus_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_fitness_plus_small.png">
                      </figure>
                    </h2>
                  ...
                  <div class="column tvOqwqoy large-5 medium-6 small-12">
                    <div>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image jSUpjTxD image-large is-largest" alt="Apple Watch next to iPhone with Apple Fitness+ class on screen" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_fitness_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_fitness_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_fitness_large.png"><img class="image jSUpjTxD image-medium" alt="Apple Watch next to iPhone with Apple Fitness+ class on screen" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_fitness_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_fitness_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_fitness_medium.png"><img class="image jSUpjTxD image-small" alt="Apple Watch next to iPhone with Apple Fitness+ class on screen" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_fitness_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_fitness_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_fitness_small.png">
                      </figure>
                    </div>
                  </div></div></span>
            </div>
            ...
            <div class="bento-box lbnYsJvw">
              <span class="bentobox-item lNLnksoq"><div class="row kxKFqMtS large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column BKmyMXwt large-7 medium-7 small-12">
                    <h2>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image OiHeKNyh image-large is-largest" alt="Apple Care+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_applecare_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_applecare_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_applecare_large.png"><img class="image OiHeKNyh image-medium" alt="Apple Care+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_applecare_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_applecare_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_applecare_medium.png"><img class="image OiHeKNyh image-small" alt="Apple Care+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_applecare_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_applecare_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_logo_applecare_small.png">
                      </figure>
                    </h2>
                            ...
                            <div class="row wCYMQCra large-display-bleed medium-display-bleed small-display-bleed">
                              <div class="column uYocBirv">
                                <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                                    <img class="image zfQvioqp image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_large.png"><img class="image zfQvioqp image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_medium.png"><img class="image zfQvioqp image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_small.png"></figure></span>
                              </div>
                          ...
                          <li class="mwaWGCud" role="listitem">
                            <div class="row hyvCdIxB large-display-bleed medium-display-bleed small-display-bleed">
                              <div class="column BUzcYOrn large-">
                                <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                                    <img class="image QrbTzEnr image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_large.png"><img class="image QrbTzEnr image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_medium.png"><img class="image QrbTzEnr image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_small.png"></figure></span>
                              </div>
                          ...
                          <li class="ncCICdso" role="listitem">
                            <div class="row bgTBwjvn large-display-bleed medium-display-bleed small-display-bleed">
                              <div class="column OETEifzU large-">
                                <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                                    <img class="image TguKijug image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_large.png"><img class="image TguKijug image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_medium.png"><img class="image TguKijug image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_check_d0112b_34_R_small.png"></figure></span>
                              </div>
                  ...
                  <div class="column UZLRjnyB large-5 medium-5 small-12">
                    <div>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image JaiDdTpA image-large is-largest" alt="Apple Watch Series 12, Aluminium case, black color, Responsive Art watch face, Sport Band, black color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_applecare_large.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_applecare_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_applecare_large.png"><img class="image JaiDdTpA image-medium" alt="Apple Watch Series 12, Aluminium case, black color, Responsive Art watch face, Sport Band, black color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_applecare_medium.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_applecare_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_applecare_medium.png"><img class="image JaiDdTpA image-small" alt="Apple Watch Series 12, Aluminium case, black color, Responsive Art watch face, Sport Band, black color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_applecare_small.png, <?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_applecare_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_ultra/images/') ?>flex_watch_applecare_small.png">
                      </figure>
                    </div>
                  </div></div></span>
            </div>
