...
<body>
  ...
  <div id="apple-subnav"
    ...
    <div class="max-w-[1024px] mx-auto px-4 sm:px-6 h-11 sm:h-13 flex items-center justify-between py-1.5 sm:py-2.5">
      <div class="flex items-baseline space-x-2 sm:space-x-3">
        <a href="#sec-hero"
          class="text-base sm:text-lg font-bold tracking-tight text-[#1d1d1f] hover:text-[#0071e3] transition-colors">Apple Watch Series 12</a>
      </div>
      ...
      <div class="flex items-center space-x-3 sm:space-x-6 text-xs">
        ...
        <button type="button"
          ...
          data-product-key="apple_watch_series_12">
          <span>Buy Now</span>
  ...
  <div class="channel-html g3C2B89">
    ...
    <div class="section n671022 theme-dark" id="sec-hero">
          ...
          <span class="column r61E3E1 large-12"><div class="row v668095 large-display-bleed medium-display-bleed small-display-bleed">
              <span class="column y4FE218"><h2>
                  <figure class="responsive-image channel-picture has-large has-medium has-small">
                    <img class="image q98418F image-large is-largest" alt="Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>logo_hero_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>logo_hero_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>logo_hero_large.png"><img class="image q98418F image-medium" alt="Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>logo_hero_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>logo_hero_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>logo_hero_medium.png"><img class="image q98418F image-small" alt="Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>logo_hero_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>logo_hero_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>logo_hero_small.png">
                  </figure></h2></span>
            </div>
            <p class="copy l5F3CDD channel-custom-font-custom-80-headline-super" style="--focus-color: rgba(0, 125, 250, 0.6)">A work of heart.</p>
            <p class="copy g848465 channel-custom-font-custom-17-partner-message" style="--focus-color: rgba(0, 125, 250, 0.6)">The ultimate way to watch your health.</p>
            ...
            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                <img class="image hVTrUmxn image-large is-largest" alt="Two Apple Watch Series 12 devices, aluminum case, dark bronze color with olive Sport Band, one showing the Heart Rate app, the other with the Health Sensing System on the back of the watch, with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>hero_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>hero_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>hero_large.png"><img class="image hVTrUmxn image-medium" alt="Two Apple Watch Series 12 devices, aluminum case, dark bronze color with olive Sport Band, one showing the Heart Rate app, the other with the Health Sensing System on the back of the watch, with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>hero_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>hero_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>hero_medium.png"><img class="image hVTrUmxn image-small" alt="Two Apple Watch Series 12 devices, aluminum case, dark bronze color with olive Sport Band, one showing the Heart Rate app, the other with the Health Sensing System on the back of the watch, with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>hero_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>hero_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>hero_small.png"></figure></span></span>
        </div>
      </div>
    </div>
    <!--END > FIXED | HERO (DARK)--><!--BEGIN > FIXED | BENTO (DARK)-->
    <div class="section g5E5B12 theme-dark" id="sec-features">
      <div class="section-content">
                    ...
                    <div class="bento-box c3E7E9B">
                      <span class="bentobox-item g98A7C5"><div class="row a4D8BE8 medium-display-bleed small-display-bleed">
                          <div class="column SSufbRxb large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image bLQMrToq double-invert image-large is-largest" alt="Health Sensing System with multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>health_sense_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>health_sense_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>health_sense_large.png"><img class="image bLQMrToq double-invert image-medium" alt="Health Sensing System with multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>health_sense_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>health_sense_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>health_sense_medium.png"><img class="image bLQMrToq double-invert image-small" alt="Health Sensing System with multiple round sensors with glowing green LED lights" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>health_sense_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>health_sense_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>health_sense_small.png"></figure></span>
                          </div>
                    ...
                    <div class="bento-box t22CB2B">
                      <span class="bentobox-item mCFB5F1"><div class="row v476F0C large-display-bleed medium-display-bleed small-display-bleed">
                          <div class="column v78BD0F large-12">
                            ...
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image REFMdZzb image-large is-largest" alt="Two Apple Watch Series 12 devices: aluminum case, light gold color, Daytime Vitals Slightly Off, Digital Crown, sand Sport Band, aluminum case, black color, Overnight Vitals Favorable, Digital Crown, black Sport Band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>HRV_reading_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>HRV_reading_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>HRV_reading_large.png"><img class="image REFMdZzb image-medium" alt="Two Apple Watch Series 12 devices: aluminum case, light gold color, Daytime Vitals Slightly Off, Digital Crown, sand Sport Band, aluminum case, black color, Overnight Vitals Favorable, Digital Crown, black Sport Band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>HRV_reading_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>HRV_reading_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>HRV_reading_medium.png"><img class="image REFMdZzb image-small" alt="Two Apple Watch Series 12 devices: aluminum case, light gold color, Daytime Vitals Slightly Off, Digital Crown, sand Sport Band, aluminum case, black color, Overnight Vitals Favorable, Digital Crown, black Sport Band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>HRV_reading_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>HRV_reading_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>HRV_reading_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box i2D9B06">
                      <span class="bentobox-item p049EAE"><div class="row c8BE520 large-display-bleed medium-display-bleed small-display-bleed">
                          <div class="column r40A9A6 large-12">
                            ...
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image lMKGdCsx image-large is-largest" alt="Apple Watch Series 12, aluminum case, black color, readiness score of 8, right side exterior, Digital Crown" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>ready_score_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>ready_score_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>ready_score_large.png"><img class="image lMKGdCsx image-medium" alt="Apple Watch Series 12, aluminum case, black color, readiness score of 8, right side exterior, Digital Crown" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>ready_score_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>ready_score_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>ready_score_medium.png"><img class="image lMKGdCsx image-small" alt="Apple Watch Series 12, aluminum case, black color, readiness score of 8, right side exterior, Digital Crown" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>ready_score_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>ready_score_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>ready_score_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box x76FD70">
                      <span class="bentobox-item c40C443"><div class="row d096617 large-display-bleed medium-display-bleed small-display-bleed">
                          <div class="column d4E11E3 large-12">
                            ...
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image XqsCdgoM image-large is-largest" alt="Apple Watch Series 12, aluminium case, dark bronze colour, sleep score circle graph, Digital Crown, Milanese Loop strap, dark bronze colour" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>advanced_health_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>advanced_health_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>advanced_health_large.png"><img class="image XqsCdgoM image-medium" alt="Apple Watch Series 12, aluminium case, dark bronze colour, sleep score circle graph, Digital Crown, Milanese Loop strap, dark bronze colour" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>advanced_health_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>advanced_health_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>advanced_health_medium.png"><img class="image XqsCdgoM image-small" alt="Apple Watch Series 12, aluminium case, dark bronze colour, sleep score circle graph, Digital Crown, Milanese Loop strap, dark bronze colour" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>advanced_health_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>advanced_health_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>advanced_health_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box SNhdgIuz">
                      <span class="bentobox-item YcrgZeuj"><div class="row quEPxjvJ small-display-bleed">
                          <div class="column iWkaQzym large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image SMgUHwoZ double-invert image-large is-largest" alt="A group of people running in a city while wearing Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>prog_lifestyle_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>prog_lifestyle_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>prog_lifestyle_large.png"><img class="image SMgUHwoZ double-invert image-medium" alt="A group of people running in a city while wearing Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>prog_lifestyle_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>prog_lifestyle_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>prog_lifestyle_medium.png"><img class="image SMgUHwoZ double-invert image-small" alt="A group of people running in a city while wearing Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>prog_lifestyle_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>prog_lifestyle_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>prog_lifestyle_small.png"></figure></span>
                          </div>
                    ...
                    <div class="bento-box kcAtTUBX">
                      <span class="bentobox-item CcgKQvuo"><div class="row MBMCUPtm">
                          <div class="column XcAMTazs large-12">
                            ...
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image RuNqwUBx image-large is-largest" alt="Three Apple Watch Series 12 devices, one with light gold aluminum case, Siri AI conversation, sand Sport Band, one with light gold aluminum case, personalized photo on watch face with Siri AI complication, burgundy Sport Band, and one with space gray aluminum case, Siri Recap, black Sport Band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>siri_ai_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>siri_ai_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>siri_ai_large.png"><img class="image RuNqwUBx image-medium" alt="Three Apple Watch Series 12 devices, one with light gold aluminum case, Siri AI conversation, sand Sport Band, one with light gold aluminum case, personalized photo on watch face with Siri AI complication, burgundy Sport Band, and one with space gray aluminum case, Siri Recap, black Sport Band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>siri_ai_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>siri_ai_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>siri_ai_medium.png"><img class="image RuNqwUBx image-small" alt="Three Apple Watch Series 12 devices, one with light gold aluminum case, Siri AI conversation, sand Sport Band, one with light gold aluminum case, personalized photo on watch face with Siri AI complication, burgundy Sport Band, and one with space gray aluminum case, Siri Recap, black Sport Band" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>siri_ai_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>siri_ai_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>siri_ai_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box pA916A4">
                      <span class="bentobox-item sC86EA8"><div class="row a399C67 medium-display-bleed small-display-bleed">
                          <div class="column nvcOkdtJ large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image yLtrDqmx image-large is-largest" alt="Emergency SOS icon, nested red circles with a white SOS in the middle" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>safety_SOS_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>safety_SOS_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>safety_SOS_large.png"><img class="image yLtrDqmx image-medium" alt="Emergency SOS icon, nested red circles with a white SOS in the middle" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>safety_SOS_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>safety_SOS_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>safety_SOS_medium.png"><img class="image yLtrDqmx image-small" alt="Emergency SOS icon, nested red circles with a white SOS in the middle" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>safety_SOS_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>safety_SOS_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>safety_SOS_small.png"></figure></span>
                          </div>
                    ...
                    <div class="bento-box pFA0167">
                      <span class="bentobox-item a20A1FE"><div class="row i3746B8 large-display-bleed medium-display-bleed small-display-bleed">
                          <div class="column jrTSmyoe large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image uHqCxpBB double-invert image-large is-largest" alt="A person checking their Apple Watch Series 12 outdoors" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>cell_lifestyle_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>cell_lifestyle_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>cell_lifestyle_large.png"><img class="image uHqCxpBB double-invert image-medium" alt="A person checking their Apple Watch Series 12 outdoors" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>cell_lifestyle_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>cell_lifestyle_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>cell_lifestyle_medium.png"><img class="image uHqCxpBB double-invert image-small" alt="A person checking their Apple Watch Series 12 outdoors" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>cell_lifestyle_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>cell_lifestyle_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>cell_lifestyle_small.png"></figure></span>
                          </div>
    ...
    <div class="section m4EAFD3 theme-light" id="sec-upgrade">
      <div class="section-content">
                                ...
                                <div class="bentobox-item LBjDPwqS">
                                  <div class="row plrGdiwj medium-display-bleed small-display-bleed">
                                    <div class="column QljwjjuT large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image StAlnUuF double-invert image-large is-largest" alt="Back of Apple Watch Series 12, aluminum case, dark bronze color, multiple round sensors with glowing green LED lights, left side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_large.png"><img class="image StAlnUuF double-invert image-medium" alt="Back of Apple Watch Series 12, aluminum case, dark bronze color, multiple round sensors with glowing green LED lights, left side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_medium.png"><img class="image StAlnUuF double-invert image-small" alt="Back of Apple Watch Series 12, aluminum case, dark bronze color, multiple round sensors with glowing green LED lights, left side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item GIfdtGAs">
                                  <div class="row wArzujBi large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column tRZiNZuG large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image REzLEhvQ image-large is-largest" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png"><img class="image REzLEhvQ image-medium" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png"><img class="image REzLEhvQ image-small" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item USwrTAma">
                                  <div class="row NwcUxmxA large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column kPjKbJBs large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image VjNqLxzq image-large is-largest" alt="Apple Watch Series 12, aluminum case, space gray color, sleep score circle graph, right side exterior, Digital Crown" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_sleep_score_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_sleep_score_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_sleep_score_large.png"><img class="image VjNqLxzq image-medium" alt="Apple Watch Series 12, aluminum case, space gray color, sleep score circle graph, right side exterior, Digital Crown" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_sleep_score_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_sleep_score_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_sleep_score_medium.png"><img class="image VjNqLxzq image-small" alt="Apple Watch Series 12, aluminum case, space gray color, sleep score circle graph, right side exterior, Digital Crown" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_sleep_score_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_sleep_score_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_sleep_score_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item RmIeJjnU">
                                  <div class="row Ovpaxnyy large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column KnclMmuZ large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image SPyRxCBs image-large is-largest" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_large.png"><img class="image SPyRxCBs image-medium" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_medium.png"><img class="image SPyRxCBs image-small" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item KcNMjQuO">
                                  <div class="row afsLCLvZ large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column ZYpQQMvw large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image fGkpeFyq double-invert image-large is-largest" alt="Cycle Tracking icon, a white circle with a ring of eight purple and orange discs inside" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_large.png"><img class="image fGkpeFyq double-invert image-medium" alt="Cycle Tracking icon, a white circle with a ring of eight purple and orange discs inside" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_medium.png"><img class="image fGkpeFyq double-invert image-small" alt="Cycle Tracking icon, a white circle with a ring of eight purple and orange discs inside" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item u3FF2AC">
                                  <div class="row sF25E9B medium-display-bleed small-display-bleed">
                                    <div class="column JBsxdEtE large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image d85EC65 double-invert image-large is-largest" alt="Back of Apple Watch Series 12, aluminum case, dark bronze color, multiple round sensors with glowing green LED lights, left side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_large.png"><img class="image d85EC65 double-invert image-medium" alt="Back of Apple Watch Series 12, aluminum case, dark bronze color, multiple round sensors with glowing green LED lights, left side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_medium.png"><img class="image d85EC65 double-invert image-small" alt="Back of Apple Watch Series 12, aluminum case, dark bronze color, multiple round sensors with glowing green LED lights, left side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item PjBVUoxG">
                                  <div class="row EhZFtgyP large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column HeGUVwqm large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image LdRJvjBn double-invert image-large is-largest" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png"><img class="image LdRJvjBn double-invert image-medium" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png"><img class="image LdRJvjBn double-invert image-small" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item s59DDC5">
                                  <div class="row o21B0D5 large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column wKrOSpmp large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image yB92C14 double-invert image-large is-largest" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large.png"><img class="image yB92C14 double-invert image-medium" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium.png"><img class="image yB92C14 double-invert image-small" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item eDC734E">
                                  <div class="row gCB360E large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column w07DB63 large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image jD6360C double-invert image-large is-largest" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_large.png"><img class="image jD6360C double-invert image-medium" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_medium.png"><img class="image jD6360C double-invert image-small" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item cCzZLZuQ">
                                  <div class="row qitLJtoH large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column YzFFcgug large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image pdowjbre double-invert image-large is-largest" alt="Cycle Tracking icon, a white circle with a ring of eight purple and orange discs inside" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_large.png"><img class="image pdowjbre double-invert image-medium" alt="Cycle Tracking icon, a white circle with a ring of eight purple and orange discs inside" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_medium.png"><img class="image pdowjbre double-invert image-small" alt="Cycle Tracking icon, a white circle with a ring of eight purple and orange discs inside" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_advanced_cycle_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item tCNwZwoZ">
                                  <div class="row XgXxINyF large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column xpVpJJuS large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image nbzSpVvi double-invert image-large is-largest" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png"><img class="image nbzSpVvi double-invert image-medium" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png"><img class="image nbzSpVvi double-invert image-small" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item woFsEUvC">
                                  <div class="row CFhdcqvd large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column OpsXgdrJ large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image rpBsEZms double-invert image-large is-largest" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large.png"><img class="image rpBsEZms double-invert image-medium" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium.png"><img class="image rpBsEZms double-invert image-small" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item eWxenRvD">
                                  <div class="row dzFIOAtN large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column XmBVNgss large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image VUNnNTyF double-invert image-large is-largest" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_large.png"><img class="image VUNnNTyF double-invert image-medium" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_medium.png"><img class="image VUNnNTyF double-invert image-small" alt="Health app icon, a pink heart in a white box" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_app_white_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item PeIcccyJ">
                                  <div class="row dKDeubxz large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column cncLFatO large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image HKUHivBC double-invert image-large is-largest" alt="Apple Watch Series 12, aluminum case, dark bronze color, Modular watch face, complications: day and date, Workouts, Activity rings, Apple Music, right side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_large.png"><img class="image HKUHivBC double-invert image-medium" alt="Apple Watch Series 12, aluminum case, dark bronze color, Modular watch face, complications: day and date, Workouts, Activity rings, Apple Music, right side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_medium.png"><img class="image HKUHivBC double-invert image-small" alt="Apple Watch Series 12, aluminum case, dark bronze color, Modular watch face, complications: day and date, Workouts, Activity rings, Apple Music, right side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item wydlZMtz">
                                  <div class="row KVOavKwd large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column QBrLVdmX large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image BQgwWuww image-large is-largest" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png"><img class="image BQgwWuww image-medium" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png"><img class="image BQgwWuww image-small" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item OTwaiSvA">
                                  <div class="row NaJbDDvd large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column GsnBXPpF large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image rGgmGsrd image-large is-largest" alt="High Heart Rate notification icon, a white heart outline in a red circle" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_heartrate_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_heartrate_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_heartrate_large.png"><img class="image rGgmGsrd image-medium" alt="High Heart Rate notification icon, a white heart outline in a red circle" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_heartrate_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_heartrate_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_heartrate_medium.png"><img class="image rGgmGsrd image-small" alt="High Heart Rate notification icon, a white heart outline in a red circle" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_heartrate_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_heartrate_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_heartrate_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item gUhNhjrH">
                                  <div class="row mlFiMWtN large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column tbxbAwyl large-12">
                                      ...
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image HGWngXnV image-large is-largest" alt="Apple Watch Series 12, aluminum case, dark bronze color, Modular watch face, complications: day and date, Workouts, Activity rings, Apple Music, right side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_large.png"><img class="image HGWngXnV image-medium" alt="Apple Watch Series 12, aluminum case, dark bronze color, Modular watch face, complications: day and date, Workouts, Activity rings, Apple Music, right side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_medium.png"><img class="image HGWngXnV image-small" alt="Apple Watch Series 12, aluminum case, dark bronze color, Modular watch face, complications: day and date, Workouts, Activity rings, Apple Music, right side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_larger_display_small.png"></figure></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="bentobox-item zRCdNbxy">
                                  <div class="row JkRtrsxf large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column lsineDwc large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image khNOSYqD image-large is-largest" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large.png"><img class="image khNOSYqD image-medium" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium.png"><img class="image khNOSYqD image-small" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item zUUcBDuT">
                                  <div class="row aZWlvvoa medium-display-bleed small-display-bleed">
                                    <div class="column rymqbcta large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image IrPnXqwD double-invert image-large is-largest" alt="Back of Apple Watch Series 12, aluminum case, dark bronze color, multiple round sensors with glowing green LED lights, left side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_large.png"><img class="image IrPnXqwD double-invert image-medium" alt="Back of Apple Watch Series 12, aluminum case, dark bronze color, multiple round sensors with glowing green LED lights, left side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_medium.png"><img class="image IrPnXqwD double-invert image-small" alt="Back of Apple Watch Series 12, aluminum case, dark bronze color, multiple round sensors with glowing green LED lights, left side exterior, Digital Crown, Sport Band, olive color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_health_sense_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item YWuLcyok">
                                  <div class="row uxGbswuh large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column FkyYbfyS large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image hUfFuImh image-large is-largest" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_large.png"><img class="image hUfFuImh image-medium" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_medium.png"><img class="image hUfFuImh image-small" alt="Readiness score of 8, Go For It" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_readiness_small.png"></figure></span>
                                    </div>
                                ...
                                <div class="bentobox-item OSlAWiAx">
                                  <div class="row blmRbCoP large-display-bleed medium-display-bleed small-display-bleed">
                                    <div class="column cbzLMTno large-12">
                                      <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                          <img class="image otWOJRmi image-large is-largest" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_large.png"><img class="image otWOJRmi image-medium" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_medium.png"><img class="image otWOJRmi image-small" alt="A multi-colored wave of light" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>upgraders_siri_ai_small.png"></figure></span>
                                    </div>
    ...
    <div class="section fD84CBE" id="sec-compare">
      <div class="section-content">
                      ...
                      <div role="row" class="compare-row compare-template-space-bottom compare-template-preview-item-embeded-image" data-column-group="true">
                        ...
                        <div role="cell" class="compare-column" headers="compare-header-0">
                          <div aria-hidden="false" class="PKJcYpmX embed-image">
                            <figure class="responsive-image compare-image has-large has-small">
                              <img class="image double-invert image-large is-largest" alt="Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_series_12_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_series_12_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_series_12_large.png"><img class="image double-invert image-small" alt="Apple Watch Series 12" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_series_12_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_series_12_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_series_12_small.png">
                            </figure>
                          </div>
                        </div>
                        <div role="cell" class="compare-column" headers="compare-header-1">
                          <div aria-hidden="false" class="fkRmJTBv embed-image">
                            <figure class="responsive-image compare-image has-large has-small">
                              <img class="image double-invert image-large is-largest" alt="Apple Watch Ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_ultra_4_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_ultra_4_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_ultra_4_large.png"><img class="image double-invert image-small" alt="Apple Watch Ultra 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_ultra_4_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_ultra_4_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_ultra_4_small.png">
                            </figure>
                          </div>
                        </div>
                        <div role="cell" class="compare-column" headers="compare-header-2">
                          <div aria-hidden="false" class="vCC5FA1 embed-image">
                            <figure class="responsive-image compare-image has-large has-small">
                              <img class="image double-invert image-large is-largest" alt="Apple Watch SE 3" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_SE_3_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_SE_3_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_SE_3_large.png"><img class="image double-invert image-small" alt="Apple Watch SE 3" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_SE_3_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_SE_3_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>compare_apple_watch_SE_3_small.png">
                            </figure>
                          </div>
                        </div>
                      </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="ANSbEAAr embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_applewatch_case_sizes_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_applewatch_case_sizes_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_applewatch_case_sizes_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="YrVpgTsG embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_applewatch_case_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_applewatch_case_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_applewatch_case_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="WzljhNBy embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_watchface_applewatch_case_inset_filled_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_watchface_applewatch_case_inset_filled_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_watchface_applewatch_case_inset_filled_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="YmRPMapH embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_watchhealth_heart_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_watchhealth_heart_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_watchhealth_heart_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="xeYTDJAu embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_bed_double_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_bed_double_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_bed_double_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="qyFLWhyO embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_apple_vitals_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_apple_vitals_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_apple_vitals_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="HgyeLOrE embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_cycletracking_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_cycletracking_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_cycletracking_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 49px">
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="nhsEDlzi embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_apple_intelligence_gradient_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_apple_intelligence_gradient_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_apple_intelligence_gradient_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 33px">
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="bWinYYoc embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_sos_circle_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_sos_circle_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_sos_circle_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 33px">
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="agOmXSpl embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_drop_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_drop_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_drop_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 33px">
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="uiaTsRwz embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_antenna_radiowaves_left_and_right_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_antenna_radiowaves_left_and_right_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_antenna_radiowaves_left_and_right_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="qTdDStzy embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_chip_s11_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_chip_s11_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_chip_s11_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="c956FED embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_chip_s10_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_chip_s10_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_chip_s10_elevated_large.png"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div aria-hidden="true" class="yRHpNoBt embed-image">
                                  <figure class="responsive-image compare-image has-large"><img class="image double-invert image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_battery_100percent_bolt_elevated_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_battery_100percent_bolt_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_compare_battery_100percent_bolt_elevated_large.png"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 33px">
    ...
    <div class="section iBkkSqsF theme-light" id="sec-bands">
      <div class="section-content">
            ...
            <div class="bento-box lOqIikuP">
              <span class="bentobox-item WxpHnymo"><div class="row JYVFLrvn">
                  ...
                  <div class="column MRdxnKmy large-hide medium-hide small-show large-12">
                    <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image ZtqTIKwa image-large is-largest" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_large.png"><img class="image ZtqTIKwa image-medium" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_medium.png"><img class="image ZtqTIKwa image-small" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_small.png"></figure></span>
                  </div>
                  <div class="column GIygxLBd large-show medium-show small-hide large-6 medium-6 small-12">
                    <div>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image mZjTaImD image-large is-largest" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, starlight Sport Band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_large.png"><img class="image mZjTaImD image-medium" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, starlight Sport Band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_medium.png"><img class="image mZjTaImD image-small" alt="Apple Watch Series 11 bands: purple fog Sport Band, anchor blue Ocean band, starlight Sport Band, light blue Alpine Loop" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_bands_small.png">
                      </figure>
                    </div>
                  </div></div></span>
            </div>
            ...
            <div class="bento-box seNZSMxa">
              <span class="bentobox-item sOxsNJth"><div class="row MgOscZzo large-display-bleed medium-display-bleed small-display-bleed">
                  ...
                  <div class="column tpDIkdyD large-6 medium-6 small-12">
                    <div>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image IOgxNpwA image-large is-largest" alt="Apple Watch Series 12, aluminum case, black color, black Sport Band, Apple Music app open, paired with AirPods 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_watch_and_airpods_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_watch_and_airpods_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_watch_and_airpods_large.png"><img class="image IOgxNpwA image-medium" alt="Apple Watch Series 12, aluminum case, black color, black Sport Band, Apple Music app open, paired with AirPods 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_watch_and_airpods_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_watch_and_airpods_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_watch_and_airpods_medium.png"><img class="image IOgxNpwA image-small" alt="Apple Watch Series 12, aluminum case, black color, black Sport Band, Apple Music app open, paired with AirPods 4" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_watch_and_airpods_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_watch_and_airpods_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_watch_and_airpods_small.png">
                      </figure>
                    </div>
                  </div></div></span>
            </div>
            ...
            <div class="bento-box KcMwJttO">
              <span class="bentobox-item hjcaPjAh"><div class="row FFLxaCso large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column vCjRBLwu large-7 medium-6 small-12">
                    <h2>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image deJvIgvf image-large is-largest" alt="Apple Fitness+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_fitness_plus_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_fitness_plus_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_fitness_plus_large.png"><img class="image deJvIgvf image-medium" alt="Apple Fitness+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_fitness_plus_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_fitness_plus_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_fitness_plus_medium.png"><img class="image deJvIgvf image-small" alt="Apple Fitness+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_fitness_plus_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_fitness_plus_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_fitness_plus_small.png">
                      </figure>
                    </h2>
                  ...
                  <div class="column PYwGlCxS large-5 medium-6 small-12">
                    <div>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image gwwuSgmd image-large is-largest" alt="Apple Watch next to iPhone with Apple Fitness+ class on screen" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_fitness_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_fitness_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_fitness_large.png"><img class="image gwwuSgmd image-medium" alt="Apple Watch next to iPhone with Apple Fitness+ class on screen" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_fitness_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_fitness_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_fitness_medium.png"><img class="image gwwuSgmd image-small" alt="Apple Watch next to iPhone with Apple Fitness+ class on screen" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_fitness_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_fitness_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_fitness_small.png">
                      </figure>
                    </div>
                  </div></div></span>
            </div>
    ...
    <div class="section HlGDKTpl theme-light" id="sec-applecare">
      <div class="section-content">
            ...
            <div class="bento-box IZAmWzuy">
              <span class="bentobox-item idqIXOvB"><div class="row zvcjDVtI large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column NMpQgImm large-7 medium-7 small-12">
                    <h2>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image vikUzFxx image-large is-largest" alt="Apple Care+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_applecare_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_applecare_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_applecare_large.png"><img class="image vikUzFxx image-medium" alt="Apple Care+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_applecare_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_applecare_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_applecare_medium.png"><img class="image vikUzFxx image-small" alt="Apple Care+" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_applecare_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_applecare_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_logo_applecare_small.png">
                      </figure>
                    </h2>
                            ...
                            <div class="row YZktQhrs large-display-bleed medium-display-bleed small-display-bleed">
                              <div class="column zYYEMMBQ">
                                <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                                    <img class="image FelGOimJ image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_large.png"><img class="image FelGOimJ image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_medium.png"><img class="image FelGOimJ image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_small.png"></figure></span>
                              </div>
                          ...
                          <li class="lSAiiUmA" role="listitem">
                            <div class="row UmzBequj large-display-bleed medium-display-bleed small-display-bleed">
                              <div class="column OUrRwPmi large-">
                                <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                                    <img class="image SgXjnGvt image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_large.png"><img class="image SgXjnGvt image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_medium.png"><img class="image SgXjnGvt image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_small.png"></figure></span>
                              </div>
                          ...
                          <li class="qcVfiftp" role="listitem">
                            <div class="row DPYpYzuE large-display-bleed medium-display-bleed small-display-bleed">
                              <div class="column QyQBvqwa large-">
                                <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                                    <img class="image axFkNNvP image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_large.png"><img class="image axFkNNvP image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_medium.png"><img class="image axFkNNvP image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>flex_check_d0112b_34_R_small.png"></figure></span>
                              </div>
                  ...
                  <div class="column TxJlhdnd large-5 medium-5 small-12">
                    <div>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image ihzgLTqC image-large is-largest" alt="Apple Watch Series 12, aluminum case, black color, Responsive Art watch face, Sport Band, black color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_flex_watch_applecare_large.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_flex_watch_applecare_large_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_flex_watch_applecare_large.png"><img class="image ihzgLTqC image-medium" alt="Apple Watch Series 12, aluminum case, black color, Responsive Art watch face, Sport Band, black color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_flex_watch_applecare_medium.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_flex_watch_applecare_medium_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_flex_watch_applecare_medium.png"><img class="image ihzgLTqC image-small" alt="Apple Watch Series 12, aluminum case, black color, Responsive Art watch face, Sport Band, black color" loading="lazy" srcset="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_flex_watch_applecare_small.png, <?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_flex_watch_applecare_small_2x.png 2x" src="<?= base_url('appleProducts/apple_watch_series_12/images/') ?>icon_flex_watch_applecare_small.png">
                      </figure>
                    </div>
                  </div></div></span>
            </div>
    ...
    <div class="section wBC50AE" id="sec-legal">
      <div class="section-content">
