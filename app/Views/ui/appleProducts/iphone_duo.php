        ...
        <div class="row t3379E5">
          <span class="column yC27179 large-12"><div class="row n726BCA large-display-bleed medium-display-bleed small-display-bleed">
              <span class="column h1FC7F6"><h2>
                  <figure class="responsive-image channel-picture has-large has-medium has-small">
                    <img class="image c391FEA image-large is-largest" alt="iPhone Duo" loading="lazy" srcset="<?= base_url('appleProducts/') ?>logo_hero_large_2.png, <?= base_url('appleProducts/') ?>logo_hero_large_2x_2.png 2x" src="<?= base_url('appleProducts/') ?>logo_hero_large_2.png"><img class="image c391FEA image-medium" alt="iPhone Duo" loading="lazy" srcset="<?= base_url('appleProducts/') ?>logo_hero_medium_2.png, <?= base_url('appleProducts/') ?>logo_hero_medium_2x_2.png 2x" src="<?= base_url('appleProducts/') ?>logo_hero_medium_2.png"><img class="image c391FEA image-small" alt="iPhone Duo" loading="lazy" srcset="<?= base_url('appleProducts/') ?>logo_hero_small_2.png, <?= base_url('appleProducts/') ?>logo_hero_small_2x_2.png 2x" src="<?= base_url('appleProducts/') ?>logo_hero_small_2.png">
                  </figure></h2></span>
            </div>
          ...
          <div class="column ajZNoavk large-12">
            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                <img class="image ysuNpxuw image-large is-largest" alt="iPhone Duo, Star White color, held by two hands in landscape orientation, unfolded, interior screen displays photos on the left, apps on the right" loading="lazy" srcset="<?= base_url('appleProducts/') ?>hero_large_3.png, <?= base_url('appleProducts/') ?>hero_large_2x_3.png 2x" src="<?= base_url('appleProducts/') ?>hero_large_3.png"><img class="image ysuNpxuw image-medium" alt="iPhone Duo, Star White color, held by two hands in landscape orientation, unfolded, interior screen displays photos on the left, apps on the right" loading="lazy" srcset="<?= base_url('appleProducts/') ?>hero_medium_3.png, <?= base_url('appleProducts/') ?>hero_medium_2x_3.png 2x" src="<?= base_url('appleProducts/') ?>hero_medium_3.png"><img class="image ysuNpxuw image-small" alt="iPhone Duo, Star White color, held by two hands in landscape orientation, unfolded, interior screen displays photos on the left, apps on the right" loading="lazy" srcset="<?= base_url('appleProducts/') ?>hero_small_3.png, <?= base_url('appleProducts/') ?>hero_small_2x_3.png 2x" src="<?= base_url('appleProducts/') ?>hero_small_3.png"></figure></span>
          </div>
        </div>
      </div>
    </div>
                    ...
                    <div class="bento-box QhxamvtP">
                      <span class="bentobox-item gLQzvgop"><div class="row wbnRFjnw medium-display-bleed small-display-bleed">
                          ...
                          <div class="column eXgTFhBm large-12 small-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image VmKbYjpj image-large is-largest" alt="iPhone Duo, opened in horizontal position, Apple TV show &quot;Shrinking&quot; plays on screen" loading="lazy" srcset="<?= base_url('appleProducts/') ?>display_large.png, <?= base_url('appleProducts/') ?>display_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>display_large.png"><img class="image VmKbYjpj image-medium" alt="iPhone Duo, opened in horizontal position, Apple TV show &quot;Shrinking&quot; plays on screen" loading="lazy" srcset="<?= base_url('appleProducts/') ?>display_medium.png, <?= base_url('appleProducts/') ?>display_medium_2x.png 2x" src="<?= base_url('appleProducts/') ?>display_medium.png"><img class="image VmKbYjpj image-small" alt="iPhone Duo, opened in horizontal position, Apple TV show &quot;Shrinking&quot; plays on screen" loading="lazy" srcset="<?= base_url('appleProducts/') ?>display_small.png, <?= base_url('appleProducts/') ?>display_small_2x.png 2x" src="<?= base_url('appleProducts/') ?>display_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box fD73AF6">
                      <span class="bentobox-item nBCE0AA"><div class="row hC324B2 medium-display-bleed small-display-bleed">
                          ...
                          <div class="column zZaDFBoL large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image PznDLCqw image-large is-largest" alt="iPhone Duo, various positions: inverted open landscape orientation, unfolded at slight angle, exterior display, all-screen design. Slightly open like a book and standing upright. Open landscape orientation, unfolded at right angle, interior display, all-screen design" loading="lazy" srcset="<?= base_url('appleProducts/') ?>unique_ios_large.png, <?= base_url('appleProducts/') ?>unique_ios_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>unique_ios_large.png"><img class="image PznDLCqw image-medium" alt="iPhone Duo, various positions: inverted open landscape orientation, unfolded at slight angle, exterior display, all-screen design. Slightly open like a book and standing upright. Open landscape orientation, unfolded at right angle, interior display, all-screen design" loading="lazy" srcset="<?= base_url('appleProducts/') ?>unique_ios_medium.png, <?= base_url('appleProducts/') ?>unique_ios_medium_2x.png 2x" src="<?= base_url('appleProducts/') ?>unique_ios_medium.png"><img class="image PznDLCqw image-small" alt="iPhone Duo, various positions: inverted open landscape orientation, unfolded at slight angle, exterior display, all-screen design. Slightly open like a book and standing upright. Open landscape orientation, unfolded at right angle, interior display, all-screen design" loading="lazy" srcset="<?= base_url('appleProducts/') ?>unique_ios_small.png, <?= base_url('appleProducts/') ?>unique_ios_small_2x.png 2x" src="<?= base_url('appleProducts/') ?>unique_ios_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box j4C731D">
                      <span class="bentobox-item nFA754D"><div class="row a7491CB large-display-bleed medium-display-bleed small-display-bleed">
                          ...
                          <div class="column VHmQuqqK large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image yEHuCzuE image-large is-largest" alt="iPhone Duo, Star White color, held by two hands in horizontal orientation, unfolded, left panel shows 48MP Dual Fusion rear cameras, right panel shows person getting their picture taken on outer display, the subject of the photo is able to see their face as their picture is getting taken using Duo Preview" loading="lazy" srcset="<?= base_url('appleProducts/') ?>48mp_camera_large.png, <?= base_url('appleProducts/') ?>48mp_camera_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>48mp_camera_large.png"><img class="image yEHuCzuE image-medium" alt="iPhone Duo, Star White color, held by two hands in horizontal orientation, unfolded, left panel shows 48MP Dual Fusion rear cameras, right panel shows person getting their picture taken on outer display, the subject of the photo is able to see their face as their picture is getting taken using Duo Preview" loading="lazy" srcset="<?= base_url('appleProducts/') ?>48mp_camera_medium.png, <?= base_url('appleProducts/') ?>48mp_camera_medium_2x.png 2x" src="<?= base_url('appleProducts/') ?>48mp_camera_medium.png"><img class="image yEHuCzuE image-small" alt="iPhone Duo, Star White color, held by two hands in horizontal orientation, unfolded, left panel shows 48MP Dual Fusion rear cameras, right panel shows person getting their picture taken on outer display, the subject of the photo is able to see their face as their picture is getting taken using Duo Preview" loading="lazy" srcset="<?= base_url('appleProducts/') ?>48mp_camera_small.png, <?= base_url('appleProducts/') ?>48mp_camera_small_2x.png 2x" src="<?= base_url('appleProducts/') ?>48mp_camera_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box z187A70">
                      <span class="bentobox-item w934F87"><div class="row z22F524 large-display-bleed medium-display-bleed small-display-bleed">
                          ...
                          <div class="column IuuJznqB large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image EvsUIXwR image-large is-largest" alt="Apple A20 Pro chip" loading="lazy" srcset="<?= base_url('appleProducts/') ?>a20_chip_large.png, <?= base_url('appleProducts/') ?>a20_chip_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>a20_chip_large.png"><img class="image EvsUIXwR image-medium" alt="Apple A20 Pro chip" loading="lazy" srcset="<?= base_url('appleProducts/') ?>a20_chip_medium.png, <?= base_url('appleProducts/') ?>a20_chip_medium_2x.png 2x" src="<?= base_url('appleProducts/') ?>a20_chip_medium.png"><img class="image EvsUIXwR image-small" alt="Apple A20 Pro chip" loading="lazy" srcset="<?= base_url('appleProducts/') ?>a20_chip_small.png, <?= base_url('appleProducts/') ?>a20_chip_small_2x.png 2x" src="<?= base_url('appleProducts/') ?>a20_chip_small.png"></figure></span>
                          </div>
                    ...
                    <div class="bento-box WokKECuO">
                      <span class="bentobox-item TJUsndpx"><div class="row bzkFRNsK medium-display-bleed small-display-bleed">
                          <div class="column ViRBSHon large-4 medium-4 small-12">
                            <div class="row NbReamxw large-display-bleed medium-display-bleed small-display-bleed">
                              ...
                              <div class="column cSCmayvy large-hide medium-hide small-show large-12">
                                <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                    <img class="image MbNYBIrD image-large is-largest" alt="iPhone Duo, held with one hand, opened in horizontal orientation, fully unfolded, interior screen displays Apple TV show &quot;Silo&quot;" loading="lazy" srcset="<?= base_url('appleProducts/') ?>battery_large_1.png, <?= base_url('appleProducts/') ?>battery_large_2x_1.png 2x" src="<?= base_url('appleProducts/') ?>battery_large_1.png"><img class="image MbNYBIrD image-medium" alt="iPhone Duo, held with one hand, opened in horizontal orientation, fully unfolded, interior screen displays Apple TV show &quot;Silo&quot;" loading="lazy" srcset="<?= base_url('appleProducts/') ?>battery_medium_1.png, <?= base_url('appleProducts/') ?>battery_medium_2x_1.png 2x" src="<?= base_url('appleProducts/') ?>battery_medium_1.png"><img class="image MbNYBIrD image-small" alt="iPhone Duo, held with one hand, opened in horizontal orientation, fully unfolded, interior screen displays Apple TV show &quot;Silo&quot;" loading="lazy" srcset="<?= base_url('appleProducts/') ?>battery_small_1.png, <?= base_url('appleProducts/') ?>battery_small_2x_1.png 2x" src="<?= base_url('appleProducts/') ?>battery_small_1.png"></figure></span>
                              </div>
                          ...
                          <div class="column tilEenvO large-show medium-show small-hide large-8 medium-8 small-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image TVaTzNyd image-large is-largest" alt="iPhone Duo, held with one hand, opened in horizontal orientation, fully unfolded, interior screen displays Apple TV show &quot;Silo&quot;" loading="lazy" srcset="<?= base_url('appleProducts/') ?>battery_large_1.png, <?= base_url('appleProducts/') ?>battery_large_2x_1.png 2x" src="<?= base_url('appleProducts/') ?>battery_large_1.png"><img class="image TVaTzNyd image-medium" alt="iPhone Duo, held with one hand, opened in horizontal orientation, fully unfolded, interior screen displays Apple TV show &quot;Silo&quot;" loading="lazy" srcset="<?= base_url('appleProducts/') ?>battery_medium_1.png, <?= base_url('appleProducts/') ?>battery_medium_2x_1.png 2x" src="<?= base_url('appleProducts/') ?>battery_medium_1.png"><img class="image TVaTzNyd image-small" alt="iPhone Duo, held with one hand, opened in horizontal orientation, fully unfolded, interior screen displays Apple TV show &quot;Silo&quot;" loading="lazy" srcset="<?= base_url('appleProducts/') ?>battery_small_1.png, <?= base_url('appleProducts/') ?>battery_small_2x_1.png 2x" src="<?= base_url('appleProducts/') ?>battery_small_1.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box y65C596">
                      <span class="bentobox-item rFA5790"><div class="row iC9DE4B large-display-bleed medium-display-bleed small-display-bleed">
                          ...
                          <div class="column KggtxHur large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image hBmjEAnf image-large is-largest" alt="iPhone Duo, partially open like a book with hinge mechanism in the center, exterior back panel on the left features an Apple logo and dual-camera, outer display on the right shows a portrait photo of a person with blonde hair" loading="lazy" srcset="<?= base_url('appleProducts/') ?>titaniumframe_large.png, <?= base_url('appleProducts/') ?>titaniumframe_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>titaniumframe_large.png"><img class="image hBmjEAnf image-medium" alt="iPhone Duo, partially open like a book with hinge mechanism in the center, exterior back panel on the left features an Apple logo and dual-camera, outer display on the right shows a portrait photo of a person with blonde hair" loading="lazy" srcset="<?= base_url('appleProducts/') ?>titaniumframe_medium.png, <?= base_url('appleProducts/') ?>titaniumframe_medium_2x.png 2x" src="<?= base_url('appleProducts/') ?>titaniumframe_medium.png"><img class="image hBmjEAnf image-small" alt="iPhone Duo, partially open like a book with hinge mechanism in the center, exterior back panel on the left features an Apple logo and dual-camera, outer display on the right shows a portrait photo of a person with blonde hair" loading="lazy" srcset="<?= base_url('appleProducts/') ?>titaniumframe_small.png, <?= base_url('appleProducts/') ?>titaniumframe_small_2x.png 2x" src="<?= base_url('appleProducts/') ?>titaniumframe_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box l2D24B8">
                      <span class="bentobox-item d8A2915"><div class="row Tqtjbqrf large-display-bleed medium-display-bleed small-display-bleed">
                          <div class="column pLGlhayh large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image opXieOBM image-large is-largest" alt="Siri AI. Your AI assistant. More personal. More powerful." loading="lazy" srcset="<?= base_url('appleProducts/') ?>siri_headline_large.png, <?= base_url('appleProducts/') ?>siri_headline_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>siri_headline_large.png"><img class="image opXieOBM image-medium" alt="Siri AI. Your AI assistant. More personal. More powerful." loading="lazy" srcset="<?= base_url('appleProducts/') ?>siri_headline_medium.png, <?= base_url('appleProducts/') ?>siri_headline_medium_2x.png 2x" src="<?= base_url('appleProducts/') ?>siri_headline_medium.png"><img class="image opXieOBM image-small" alt="Siri AI. Your AI assistant. More personal. More powerful." loading="lazy" srcset="<?= base_url('appleProducts/') ?>siri_headline_small.png, <?= base_url('appleProducts/') ?>siri_headline_small_2x.png 2x" src="<?= base_url('appleProducts/') ?>siri_headline_small.png"></figure></span>
                          ...
                          <div class="column uxJxgIvt large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image XroAATBB image-large is-largest" alt="iPhone Duo, folded, outer display shows Siri AI notification indicating a calendar update" loading="lazy" srcset="<?= base_url('appleProducts/') ?>siri_ai_large_2.png, <?= base_url('appleProducts/') ?>siri_ai_large_2x_2.png 2x" src="<?= base_url('appleProducts/') ?>siri_ai_large_2.png"><img class="image XroAATBB image-medium" alt="iPhone Duo, folded, outer display shows Siri AI notification indicating a calendar update" loading="lazy" srcset="<?= base_url('appleProducts/') ?>siri_ai_medium_2.png, <?= base_url('appleProducts/') ?>siri_ai_medium_2x_2.png 2x" src="<?= base_url('appleProducts/') ?>siri_ai_medium_2.png"><img class="image XroAATBB image-small" alt="iPhone Duo, folded, outer display shows Siri AI notification indicating a calendar update" loading="lazy" srcset="<?= base_url('appleProducts/') ?>siri_ai_small_2.png, <?= base_url('appleProducts/') ?>siri_ai_small_2x_2.png 2x" src="<?= base_url('appleProducts/') ?>siri_ai_small_2.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="bento-box nD43E01">
                      <span class="bentobox-item x719B8B"><div class="row sB5C06C large-display-bleed medium-display-bleed small-display-bleed">
                          ...
                          <div class="column rUuruYqW large-12">
                            <span><figure class="responsive-image channel-picture has-large has-medium has-small">
                                <img class="image MZwJRNuF image-large is-largest" alt="iPhone Duo, Star White color in Sand Silicone Case, landscape orientation, fully opened horizontally, Dual Fusion cameras on the top left, case covers the back exterior and outer edge of the front display, right side features portrait of person on outer display. iPhone Duo, Star White color, fully opened horizontally, Navy Blue Folio with Kickstand, fully opened horizontally, back exterior featuring the 48MP Dual Fusion rear cameras, two lenses" loading="lazy" srcset="<?= base_url('appleProducts/') ?>accessories_large.png, <?= base_url('appleProducts/') ?>accessories_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>accessories_large.png"><img class="image MZwJRNuF image-medium" alt="iPhone Duo, Star White color in Sand Silicone Case, landscape orientation, fully opened horizontally, Dual Fusion cameras on the top left, case covers the back exterior and outer edge of the front display, right side features portrait of person on outer display. iPhone Duo, Star White color, fully opened horizontally, Navy Blue Folio with Kickstand, fully opened horizontally, back exterior featuring the 48MP Dual Fusion rear cameras, two lenses" loading="lazy" srcset="<?= base_url('appleProducts/') ?>accessories_medium.png, <?= base_url('appleProducts/') ?>accessories_medium_2x.png 2x" src="<?= base_url('appleProducts/') ?>accessories_medium.png"><img class="image MZwJRNuF image-small" alt="iPhone Duo, Star White color in Sand Silicone Case, landscape orientation, fully opened horizontally, Dual Fusion cameras on the top left, case covers the back exterior and outer edge of the front display, right side features portrait of person on outer display. iPhone Duo, Star White color, fully opened horizontally, Navy Blue Folio with Kickstand, fully opened horizontally, back exterior featuring the 48MP Dual Fusion rear cameras, two lenses" loading="lazy" srcset="<?= base_url('appleProducts/') ?>accessories_small.png, <?= base_url('appleProducts/') ?>accessories_small_2x.png 2x" src="<?= base_url('appleProducts/') ?>accessories_small.png"></figure></span>
                          </div></div></span>
                    </div>
                  </div>
                </div>
                      ...
                      <div role="row" class="compare-row compare-template-preview-item-embeded-image" data-column-group="true">
                        ...
                        <div role="cell" class="compare-column" headers="compare-header-0">
                          <div class="uZbpbauN embed-image" aria-hidden="false">
                            <figure class="responsive-image compare-image has-large has-small" aria-hidden="false">
                              <img class="image image-large is-largest" src="<?= base_url('appleProducts/') ?>compare_iphone_duo_star_white_large.png" srcset="<?= base_url('appleProducts/') ?>compare_iphone_duo_star_white_large.png, <?= base_url('appleProducts/') ?>compare_iphone_duo_star_white_large_2x.png 2x" alt="iPhone Duo" loading="lazy"><img class="image image-small" src="<?= base_url('appleProducts/') ?>compare_iphone_duo_star_white_small.png" srcset="<?= base_url('appleProducts/') ?>compare_iphone_duo_star_white_small.png, <?= base_url('appleProducts/') ?>compare_iphone_duo_star_white_small_2x.png 2x" alt="iPhone Duo" loading="lazy">
                            </figure>
                          </div>
                        </div>
                        <div role="cell" class="compare-column" headers="compare-header-1">
                          <div class="gMUYXVub embed-image" aria-hidden="false">
                            <figure class="responsive-image compare-image has-large has-small" aria-hidden="false">
                              <img class="image image-large is-largest" src="<?= base_url('appleProducts/') ?>compare_iphone_18_pro_max_burgundy_large.png" srcset="<?= base_url('appleProducts/') ?>compare_iphone_18_pro_max_burgundy_large.png, <?= base_url('appleProducts/') ?>compare_iphone_18_pro_max_burgundy_large_2x.png 2x" alt="iPhone 18 Pro Max" loading="lazy"><img class="image image-small" src="<?= base_url('appleProducts/') ?>compare_iphone_18_pro_max_burgundy_small.png" srcset="<?= base_url('appleProducts/') ?>compare_iphone_18_pro_max_burgundy_small.png, <?= base_url('appleProducts/') ?>compare_iphone_18_pro_max_burgundy_small_2x.png 2x" alt="iPhone 18 Pro Max" loading="lazy">
                            </figure>
                          </div>
                        </div>
                        <div role="cell" class="compare-column" headers="compare-header-2">
                          <div class="iwIHRtyy embed-image" aria-hidden="false">
                            <figure class="responsive-image compare-image has-large has-small" aria-hidden="false">
                              <img class="image image-large is-largest" src="<?= base_url('appleProducts/') ?>compare_iphone_17_lavender_large.png" srcset="<?= base_url('appleProducts/') ?>compare_iphone_17_lavender_large.png, <?= base_url('appleProducts/') ?>compare_iphone_17_lavender_large_2x.png 2x" alt="iPhone 17" loading="lazy"><img class="image image-small" src="<?= base_url('appleProducts/') ?>compare_iphone_17_lavender_small.png" srcset="<?= base_url('appleProducts/') ?>compare_iphone_17_lavender_small.png, <?= base_url('appleProducts/') ?>compare_iphone_17_lavender_small_2x.png 2x" alt="iPhone 17" loading="lazy">
                            </figure>
                          </div>
                        </div>
                      </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="wzLgREpC embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_iphone_1_layer_3d_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_iphone_1_layer_3d_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_iphone_1_layer_3d_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="hUHNkNxN embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_chip_a20pro_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_chip_a20pro_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_chip_a20pro_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="RUnSLPrF embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_chip_a19_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_chip_a19_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_chip_a19_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="JsJzKgpm embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_battery_100percent_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_battery_100percent_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_battery_100percent_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="nhgbtWyx embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_person_crop_rectangle_landscape_rotate_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_person_crop_rectangle_landscape_rotate_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_person_crop_rectangle_landscape_rotate_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="yUCrtavT embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_iphoneduo_crop_rear_camera_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_iphoneduo_crop_rear_camera_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_iphoneduo_crop_rear_camera_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="cOdAlyAH embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_iphone17pro_crop_rear_camera_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_iphone17pro_crop_rear_camera_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_iphone17pro_crop_rear_camera_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="cpZuxLzS embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_iphone17_crop_rear_camera_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_iphone17_crop_rear_camera_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_iphone17_crop_rear_camera_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 47px"><span class="stat-caption copy">48MP Dual Fusion camera system</span></div>
                              <div class="stat-row" style="height: 47px"><span class="stat-caption copy">48MP Fusion Main</span></div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="uAbwpzun embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_4x_3circles_zoom_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_4x_3circles_zoom_large.png, <?= base_url('appleProducts/') ?>icon_compare_4x_3circles_zoom_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="sFyXETpo embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_16x_5circles_zoom_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_16x_5circles_zoom_large.png, <?= base_url('appleProducts/') ?>icon_compare_16x_5circles_zoom_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 16px"><span class="stat-caption copy">Optical zoom options</span></div>
                            </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="mdNSVxyb embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_apple_intelligence_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_apple_intelligence_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_apple_intelligence_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="OOpsoZob embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_sos_circle_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_sos_circle_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_sos_circle_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="qXcSchrR embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_port_usb_c_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_port_usb_c_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_port_usb_c_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                            ...
                            <div class="stat-content">
                              <div class="stat-row">
                                <div class="miHyKBzG embed-image" aria-hidden="true">
                                  <figure class="responsive-image compare-image has-large" aria-hidden="true"><img class="image double-invert image-large is-largest" src="<?= base_url('appleProducts/') ?>icon_compare_5g_radiowaves_elevated_large.png" srcset="<?= base_url('appleProducts/') ?>icon_compare_5g_radiowaves_elevated_large.png, <?= base_url('appleProducts/') ?>icon_compare_5g_radiowaves_elevated_large_2x.png 2x" alt="" loading="lazy"></figure>
                                </div>
                              </div>
                              <div class="stat-row" style="height: 18px">
              ...
              <span class="bentobox-item n377B7B"><div class="row bE0EE4B large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column q289D1E large-12">
                    <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                        <img class="image w6E913C image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_apple_logo_lock_elevated_large.png, <?= base_url('appleProducts/') ?>icon_flex_apple_logo_lock_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_apple_logo_lock_elevated_large.png"><img class="image w6E913C image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_apple_logo_lock_elevated_large.png, <?= base_url('appleProducts/') ?>icon_flex_apple_logo_lock_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_apple_logo_lock_elevated_large.png"><img class="image w6E913C image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_apple_logo_lock_elevated_small.png, <?= base_url('appleProducts/') ?>icon_flex_apple_logo_lock_elevated_small_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_apple_logo_lock_elevated_small.png"></figure></span>
            ...
            <div class="bento-box g162157">
              <span class="bentobox-item v0F2AFF"><div class="row ChfpAizI large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column atmMbeAX large-12">
                    <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                        <img class="image gpgNDxmC image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_earth_americas_elevated_large.png, <?= base_url('appleProducts/') ?>icon_flex_earth_americas_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_earth_americas_elevated_large.png"><img class="image gpgNDxmC image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_earth_americas_elevated_large.png, <?= base_url('appleProducts/') ?>icon_flex_earth_americas_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_earth_americas_elevated_large.png"><img class="image gpgNDxmC image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_earth_americas_elevated_large.png, <?= base_url('appleProducts/') ?>icon_flex_earth_americas_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_earth_americas_elevated_large.png"></figure></span>
            ...
            <div class="bento-box DHvaAass">
              <span class="bentobox-item mGqCDNBI"><div class="row vrwpoGye large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column USQtTLuo large-12">
                    <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                        <img class="image pjLSyXBn image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_iphone_and_iphone_elevated_large.png, <?= base_url('appleProducts/') ?>icon_flex_iphone_and_iphone_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_iphone_and_iphone_elevated_large.png"><img class="image pjLSyXBn image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_iphone_and_iphone_elevated_large.png, <?= base_url('appleProducts/') ?>icon_flex_iphone_and_iphone_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_iphone_and_iphone_elevated_large.png"><img class="image pjLSyXBn image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_iphone_and_iphone_elevated_small.png, <?= base_url('appleProducts/') ?>icon_flex_iphone_and_iphone_elevated_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_iphone_and_iphone_elevated_small.png"></figure></span>
            ...
            <div class="bento-box CMEeBaoR">
              <span class="bentobox-item XcgamRnf"><div class="row tTXXGxtp large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column mrcRawpD large-12">
                    <span><figure class="responsive-image channel-picture has-large has-medium has-small" aria-hidden="true">
                        <img class="image lOICOnze image-large is-largest" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_ios_large.png, <?= base_url('appleProducts/') ?>icon_flex_ios_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_ios_large.png"><img class="image lOICOnze image-medium" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_ios_large.png, <?= base_url('appleProducts/') ?>icon_flex_ios_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_ios_large.png"><img class="image lOICOnze image-small" alt="" loading="lazy" srcset="<?= base_url('appleProducts/') ?>icon_flex_ios_small.png, <?= base_url('appleProducts/') ?>icon_flex_ios_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>icon_flex_ios_small.png"></figure></span>
            ...
            <div class="bento-box KCsZfxnd">
              <span class="bentobox-item SSIMxmnG"><div class="row TgTPwcBS large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column giNTBwAi large-5 medium-6 small-12">
                    <h3>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image EazwsEsc image-large is-largest" alt="Apple TV" loading="lazy" srcset="<?= base_url('appleProducts/') ?>flex_logo_appletv_large.png, <?= base_url('appleProducts/') ?>flex_logo_appletv_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>flex_logo_appletv_large.png"><img class="image EazwsEsc image-medium" alt="Apple TV" loading="lazy" srcset="<?= base_url('appleProducts/') ?>flex_logo_appletv_large.png, <?= base_url('appleProducts/') ?>flex_logo_appletv_medium_2x.png 2x" src="<?= base_url('appleProducts/') ?>flex_logo_appletv_large.png"><img class="image EazwsEsc image-small" alt="Apple TV" loading="lazy" srcset="<?= base_url('appleProducts/') ?>flex_logo_appletv_large.png, <?= base_url('appleProducts/') ?>flex_logo_appletv_small_2x.png 2x" src="<?= base_url('appleProducts/') ?>flex_logo_appletv_large.png">
                      </figure>
                    </h3>
                  ...
                  <div class="column nRZXDsxE large-7 medium-6 small-12">
                    <div>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image QQhEOCmt double-invert image-large is-largest" alt="Apple TV show &quot;The Studio&quot;" loading="lazy" srcset="<?= base_url('appleProducts/') ?>flex_tv_large_1.png, <?= base_url('appleProducts/') ?>flex_tv_large_2x_1.png 2x" src="<?= base_url('appleProducts/') ?>flex_tv_large_1.png"><img class="image QQhEOCmt double-invert image-medium" alt="Apple TV show &quot;The Studio&quot;" loading="lazy" srcset="<?= base_url('appleProducts/') ?>flex_tv_medium_1.png, <?= base_url('appleProducts/') ?>flex_tv_medium_2x_1.png 2x" src="<?= base_url('appleProducts/') ?>flex_tv_medium_1.png"><img class="image QQhEOCmt double-invert image-small" alt="Apple TV show &quot;The Studio&quot;" loading="lazy" srcset="<?= base_url('appleProducts/') ?>flex_tv_small_1.png, <?= base_url('appleProducts/') ?>flex_tv_small_2x_1.png 2x" src="<?= base_url('appleProducts/') ?>flex_tv_small_1.png">
                      </figure>
                    </div>
                  </div></div></span>
            </div>
            ...
            <div class="bento-box CBgWcSwY">
              <span class="bentobox-item zUBlabpi"><div class="row HryIsVpw large-display-bleed medium-display-bleed small-display-bleed">
                  <div class="column KmoiGkAm large-5 medium-6 small-12">
                    <h3>
                      <figure class="responsive-image channel-picture has-large has-medium has-small">
                        <img class="image VBltJFns image-large is-largest" alt="AppleCare+" loading="lazy" srcset="<?= base_url('appleProducts/') ?>flex_logo_apple_care_plus_large.png, <?= base_url('appleProducts/') ?>flex_logo_apple_care_plus_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>flex_logo_apple_care_plus_large.png"><img class="image VBltJFns image-medium" alt="AppleCare+" loading="lazy" srcset="<?= base_url('appleProducts/') ?>flex_logo_apple_care_plus_large.png, <?= base_url('appleProducts/') ?>flex_logo_apple_care_plus_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>flex_logo_apple_care_plus_large.png"><img class="image VBltJFns image-small" alt="AppleCare+" loading="lazy" srcset="<?= base_url('appleProducts/') ?>flex_logo_apple_care_plus_large.png, <?= base_url('appleProducts/') ?>flex_logo_apple_care_plus_large_2x.png 2x" src="<?= base_url('appleProducts/') ?>flex_logo_apple_care_plus_large.png">
                      </figure>
                    </h3>
