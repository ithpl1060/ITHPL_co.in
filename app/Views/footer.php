...
<!-- <script src="</?php echo base_url() . 'resource/js/bootstrap-editable.js'; ?>"></script>
<script src="</?php echo base_url() . 'resource/js/form-x-editable.js'; ?>"></script> -->
<!-- SlimScroll -->
...
<!-- side_bar -->
<script src="<?php  //echo base_url() . 'resource/js/custom/employee_footer_import.js'; 
                ?>"></script>
...
<script>
    const empData = JSON.parse(sessionStorage.getItem("empDetails"));

    if (empData && empData.is_admin == 1) {
